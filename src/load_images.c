...
static void	load_player_images(t_game *game, int *w, int *h)
{
	...
	game->img_run_up_1 = mlx_xpm_file_to_image(game->mlx, "assets/Player/run_up_1.xpm", w, h);
	game->img_run_up_2 = mlx_xpm_file_to_image(game->mlx, "assets/Player/run_up_2.xpm", w, h);
	game->img_run_down_1 = mlx_xpm_file_to_image(game->mlx, "assets/Player/run_down_1.xpm", w, h);
	game->img_run_down_2 = mlx_xpm_file_to_image(game->mlx, "assets/Player/run_down_2.xpm", w, h);
	game->img_run_left_1 = mlx_xpm_file_to_image(game->mlx, "assets/Player/run_left_1.xpm", w, h);
	game->img_run_left_2 = mlx_xpm_file_to_image(game->mlx, "assets/Player/run_left_2.xpm", w, h);
	game->img_run_right_1 = mlx_xpm_file_to_image(game->mlx, "assets/Player/run_right_1.xpm", w, h);
	game->img_run_right_2 = mlx_xpm_file_to_image(game->mlx, "assets/Player/run_right_2.xpm", w, h);
}
